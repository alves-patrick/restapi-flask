...
```console
helm install my-release oci://REGISTRY_NAME/REPOSITORY_NAME/mongodb --set "global.imagePullSecrets[0]=SECRET_NAME" -n NAMESPACE
```
...
Refer to our detailed [tutorial on backing up and restoring MongoDB&reg; chart deployments on Kubernetes](https://techdocs.broadcom.com/us/en/vmware-tanzu/bitnami-secure-images/bitnami-secure-images/services/bsi-doc/apps-tutorials-backup-restore-data-mongodb-kubernetes-index.html), which covers both these approaches, for more information.
...
This chart includes an optional MCP (Model Context Protocol) component that provides a standardized interface for AI assistants and LLMs to interact with MongoDB. When enabled, it deploys a separate service that exposes MongoDB functionality through the MCP protocol. The upstream project is available at [mongodb-js/mongodb-mcp](https://github.com/mongodb-js/mongodb-mcp). To enable the MCP component, set `mcp.enabled=true`:

#### MCP Configuration

By default (`mcp.useRootCredentials=true`), the MCP component automatically connects to the main MongoDB instance using the root credentials. The connection string is passed via the `--connectionString` argument.
...
mcp:
  ...
  extraEnvVars:
    ...
    - name: MONGODB_CONNECTION_STRING
      value: mongodb://my-custom-user:password@mongodb-service:27017/mydb
```
...
| `externalAccess.service.annotationsList`                      | Service annotations for each external service. This value contains a list allowing different annotations per each external service.                                                                                                                                         | `[]`                      |
...
| `externalAccess.hidden.service.allocateLoadBalancerNodePorts` | Whether to allocate node ports when service type is LoadBalancer                                                                                                                                                                                                            | `true`                    |
...
| `hidden.annotations`                                       | Additional labels to be added to the hidden node statefulset                                                                                                                                                                    | `{}`                |
...
| Name                                                         | Description                                                                                                                                                                                                                         | Value                             |
| ------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------- |
| `mcp.enabled`                                                | Enable MCP MongoDB deployment                                                                                                                                                                                                       | `false`                           |
| `mcp.useRootCredentials`                                     | Use MongoDB root credentials for MCP. If false, users must provide their own credentials via MONGODB_USERNAME, MONGODB_PASSWORD and MONGODB_DATABASE env. vars                                                                      | `true`                            |
| `mcp.readOnly`                                               | Enable read-only mode for MCP MongoDB server                                                                                                                                                                                        | `true`                            |
| `mcp.replicaCount`                                           | Number of MCP MongoDB replicas                                                                                                                                                                                                      | `1`                               |
| `mcp.image.registry`                                         | MCP MongoDB image registry                                                                                                                                                                                                          | `REGISTRY_NAME`                   |
| `mcp.image.repository`                                       | MCP MongoDB image repository                                                                                                                                                                                                        | `REPOSITORY_NAME/mcp-mongodb`     |
| `mcp.image.digest`                                           | MCP MongoDB image digest in the way sha256:aa.... Please note this parameter, if set, will override the tag                                                                                                                         | `""`                              |
| `mcp.image.pullPolicy`                                       | MCP MongoDB image pull policy                                                                                                                                                                                                       | `IfNotPresent`                    |
| `mcp.image.pullSecrets`                                      | MCP MongoDB image pull secrets                                                                                                                                                                                                      | `[]`                              |
| `mcp.containerPorts.http`                                    | MCP MongoDB HTTP container port                                                                                                                                                                                                     | `8000`                            |
| `mcp.extraContainerPorts`                                    | Optionally specify extra list of additional container ports                                                                                                                                                                         | `[]`                              |
| `mcp.command`                                                | Override default container command (useful when using custom images)                                                                                                                                                                | `[]`                              |
| `mcp.args`                                                   | Override default container args (useful when using custom images)                                                                                                                                                                   | `[]`                              |
| `mcp.extraArgs`                                              | Add extra arguments to the default args                                                                                                                                                                                             | `[]`                              |
| `mcp.automountServiceAccountToken`                           | Mount Service Account token in pod                                                                                                                                                                                                  | `true`                            |
| `mcp.hostAliases`                                            | MCP MongoDB pods host aliases                                                                                                                                                                                                       | `[]`                              |
| `mcp.podLabels`                                              | Extra labels for MCP MongoDB pods                                                                                                                                                                                                   | `{}`                              |
| `mcp.podAnnotations`                                         | Annotations for MCP MongoDB pods                                                                                                                                                                                                    | `{}`                              |
| `mcp.podAffinityPreset`                                      | Pod affinity preset. Ignored if `mcp.affinity` is set. Allowed values: `soft` or `hard`                                                                                                                                             | `""`                              |
| `mcp.podAntiAffinityPreset`                                  | Pod anti-affinity preset. Ignored if `mcp.affinity` is set. Allowed values: `soft` or `hard`                                                                                                                                        | `soft`                            |
| `mcp.nodeAffinityPreset.type`                                | Node affinity preset type. Ignored if `mcp.affinity` is set. Allowed values: `soft` or `hard`                                                                                                                                       | `""`                              |
| `mcp.nodeAffinityPreset.key`                                 | Node label key to match. Ignored if `mcp.affinity` is set                                                                                                                                                                           | `""`                              |
| `mcp.nodeAffinityPreset.values`                              | Node label values to match. Ignored if `mcp.affinity` is set                                                                                                                                                                        | `[]`                              |
| `mcp.affinity`                                               | Affinity for MCP MongoDB pods assignment                                                                                                                                                                                            | `{}`                              |
| `mcp.nodeSelector`                                           | Node labels for MCP MongoDB pods assignment                                                                                                                                                                                         | `{}`                              |
| `mcp.tolerations`                                            | Tolerations for MCP MongoDB pods assignment                                                                                                                                                                                         | `[]`                              |
| `mcp.updateStrategy.type`                                    | MCP MongoDB deployment strategy type                                                                                                                                                                                                | `RollingUpdate`                   |
| `mcp.priorityClassName`                                      | MCP MongoDB pods' priorityClassName                                                                                                                                                                                                 | `""`                              |
| `mcp.topologySpreadConstraints`                              | Topology Spread Constraints for pod assignment spread across your cluster among failure-domains                                                                                                                                     | `[]`                              |
| `mcp.schedulerName`                                          | Name of the k8s scheduler (other than default) for MCP MongoDB pods                                                                                                                                                                 | `""`                              |
| `mcp.runtimeClassName`                                       | Name of the runtime class to be used by MCP MongoDB pods                                                                                                                                                                            | `""`                              |
| `mcp.terminationGracePeriodSeconds`                          | Seconds MCP MongoDB pod needs to terminate gracefully                                                                                                                                                                               | `""`                              |
| `mcp.lifecycleHooks`                                         | for the MCP MongoDB container(s) to automate configuration before or after startup                                                                                                                                                  | `{}`                              |
| `mcp.extraEnvVars`                                           | Array with extra environment variables to add to MCP MongoDB nodes                                                                                                                                                                  | `[]`                              |
| `mcp.extraEnvVarsCM`                                         | Name of existing ConfigMap containing extra env vars for MCP MongoDB nodes                                                                                                                                                          | `""`                              |
| `mcp.extraEnvVarsSecret`                                     | Name of existing Secret containing extra env vars for MCP MongoDB nodes                                                                                                                                                             | `""`                              |
| `mcp.extraVolumes`                                           | Optionally specify extra list of additional volumes for the MCP MongoDB pod(s)                                                                                                                                                      | `[]`                              |
| `mcp.extraVolumeMounts`                                      | Optionally specify extra list of additional volumeMounts for the MCP MongoDB container(s)                                                                                                                                           | `[]`                              |
| `mcp.sidecars`                                               | Add additional sidecar containers to the MCP MongoDB pod(s)                                                                                                                                                                         | `[]`                              |
| `mcp.initContainers`                                         | Add additional init containers to the MCP MongoDB pod(s)                                                                                                                                                                            | `[]`                              |
| `mcp.podSecurityContext.enabled`                             | Enabled MCP MongoDB pods' Security Context                                                                                                                                                                                          | `true`                            |
| `mcp.podSecurityContext.fsGroupChangePolicy`                 | Set filesystem group change policy                                                                                                                                                                                                  | `Always`                          |
| `mcp.podSecurityContext.sysctls`                             | Set kernel settings using the sysctl interface                                                                                                                                                                                      | `[]`                              |
| `mcp.podSecurityContext.supplementalGroups`                  | Set filesystem extra groups                                                                                                                                                                                                         | `[]`                              |
| `mcp.podSecurityContext.fsGroup`                             | Set MCP MongoDB pod's Security Context fsGroup                                                                                                                                                                                      | `1001`                            |
| `mcp.containerSecurityContext.enabled`                       | Enabled containers' Security Context                                                                                                                                                                                                | `true`                            |
| `mcp.containerSecurityContext.seLinuxOptions`                | Set SELinux options in container                                                                                                                                                                                                    | `{}`                              |
| `mcp.containerSecurityContext.runAsUser`                     | Set containers' Security Context runAsUser                                                                                                                                                                                          | `1001`                            |
| `mcp.containerSecurityContext.runAsGroup`                    | Set containers' Security Context runAsGroup                                                                                                                                                                                         | `1001`                            |
| `mcp.containerSecurityContext.runAsNonRoot`                  | Set container's Security Context runAsNonRoot                                                                                                                                                                                       | `true`                            |
| `mcp.containerSecurityContext.privileged`                    | Set container's Security Context privileged                                                                                                                                                                                         | `false`                           |
| `mcp.containerSecurityContext.readOnlyRootFilesystem`        | Set container's Security Context readOnlyRootFilesystem                                                                                                                                                                             | `true`                            |
| `mcp.containerSecurityContext.allowPrivilegeEscalation`      | Set container's Security Context allowPrivilegeEscalation                                                                                                                                                                           | `false`                           |
| `mcp.containerSecurityContext.capabilities.drop`             | List of capabilities to be dropped                                                                                                                                                                                                  | `["ALL"]`                         |
| `mcp.containerSecurityContext.seccompProfile.type`           | Set container's Security Context seccomp profile                                                                                                                                                                                    | `RuntimeDefault`                  |
| `mcp.resourcesPreset`                                        | Set container resources according to one common preset (allowed values: none, nano, micro, small, medium, large, xlarge, 2xlarge). This is ignored if mcp.resources is set (mcp.resources is recommended for production).           | `small`                           |
| `mcp.resources`                                              | Set container requests and limits for different resources like CPU or memory (essential for production workloads)                                                                                                                   | `{}`                              |
| `mcp.fips.openssl`                                           | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                  | `""`                              |
| `mcp.livenessProbe.enabled`                                  | Enable livenessProbe on MCP MongoDB containers                                                                                                                                                                                      | `true`                            |
| `mcp.livenessProbe.initialDelaySeconds`                      | Initial delay seconds for livenessProbe                                                                                                                                                                                             | `5`                               |
| `mcp.livenessProbe.periodSeconds`                            | Period seconds for livenessProbe                                                                                                                                                                                                    | `10`                              |
| `mcp.livenessProbe.timeoutSeconds`                           | Timeout seconds for livenessProbe                                                                                                                                                                                                   | `5`                               |
| `mcp.livenessProbe.failureThreshold`                         | Failure threshold for livenessProbe                                                                                                                                                                                                 | `5`                               |
| `mcp.livenessProbe.successThreshold`                         | Success threshold for livenessProbe                                                                                                                                                                                                 | `1`                               |
| `mcp.readinessProbe.enabled`                                 | Enable readinessProbe on MCP MongoDB containers                                                                                                                                                                                     | `true`                            |
| `mcp.readinessProbe.initialDelaySeconds`                     | Initial delay seconds for readinessProbe                                                                                                                                                                                            | `5`                               |
| `mcp.readinessProbe.periodSeconds`                           | Period seconds for readinessProbe                                                                                                                                                                                                   | `10`                              |
| `mcp.readinessProbe.timeoutSeconds`                          | Timeout seconds for readinessProbe                                                                                                                                                                                                  | `5`                               |
| `mcp.readinessProbe.failureThreshold`                        | Failure threshold for readinessProbe                                                                                                                                                                                                | `5`                               |
| `mcp.readinessProbe.successThreshold`                        | Success threshold for readinessProbe                                                                                                                                                                                                | `1`                               |
| `mcp.startupProbe.enabled`                                   | Enable startupProbe on MCP MongoDB containers                                                                                                                                                                                       | `false`                           |
| `mcp.startupProbe.initialDelaySeconds`                       | Initial delay seconds for startupProbe                                                                                                                                                                                              | `5`                               |
| `mcp.startupProbe.periodSeconds`                             | Period seconds for startupProbe                                                                                                                                                                                                     | `10`                              |
| `mcp.startupProbe.timeoutSeconds`                            | Timeout seconds for startupProbe                                                                                                                                                                                                    | `5`                               |
| `mcp.startupProbe.failureThreshold`                          | Failure threshold for startupProbe                                                                                                                                                                                                  | `5`                               |
| `mcp.startupProbe.successThreshold`                          | Success threshold for startupProbe                                                                                                                                                                                                  | `1`                               |
| `mcp.customLivenessProbe`                                    | Custom livenessProbe that overrides the default one                                                                                                                                                                                 | `{}`                              |
| `mcp.customReadinessProbe`                                   | Custom readinessProbe that overrides the default one                                                                                                                                                                                | `{}`                              |
| `mcp.customStartupProbe`                                     | Custom startupProbe that overrides the default one                                                                                                                                                                                  | `{}`                              |
| `mcp.pdb.create`                                             | Enable/disable a Pod Disruption Budget creation                                                                                                                                                                                     | `true`                            |
| `mcp.pdb.minAvailable`                                       | Minimum number/percentage of pods that should remain scheduled                                                                                                                                                                      | `""`                              |
| `mcp.pdb.maxUnavailable`                                     | Maximum number/percentage of pods that may be made unavailable                                                                                                                                                                      | `""`                              |
| `mcp.autoscaling.vpa.enabled`                                | Enable VPA                                                                                                                                                                                                                          | `false`                           |
| `mcp.autoscaling.vpa.annotations`                            | Annotations for VPA resource                                                                                                                                                                                                        | `{}`                              |
| `mcp.autoscaling.vpa.controlledResources`                    | VPA List of resources that the vertical pod autoscaler can control. Defaults to cpu and memory                                                                                                                                      | `[]`                              |
| `mcp.autoscaling.vpa.maxAllowed`                             | VPA Max allowed resources for the pod                                                                                                                                                                                               | `{}`                              |
| `mcp.autoscaling.vpa.minAllowed`                             | VPA Min allowed resources for the pod                                                                                                                                                                                               | `{}`                              |
| `mcp.autoscaling.vpa.updatePolicy.updateMode`                | Autoscaling update policy Specifies whether recommended updates are applied when a Pod is started and whether recommended updates are applied during the life of a Pod                                                              | `Auto`                            |
| `mcp.autoscaling.hpa.enabled`                                | Enable autoscaling for MCP MongoDB                                                                                                                                                                                                  | `false`                           |
| `mcp.autoscaling.hpa.minReplicas`                            | Minimum number of MCP MongoDB replicas                                                                                                                                                                                              | `""`                              |
| `mcp.autoscaling.hpa.maxReplicas`                            | Maximum number of MCP MongoDB replicas                                                                                                                                                                                              | `""`                              |
| `mcp.autoscaling.hpa.targetCPU`                              | Target CPU utilization percentage                                                                                                                                                                                                   | `""`                              |
| `mcp.autoscaling.hpa.targetMemory`                           | Target Memory utilization percentage                                                                                                                                                                                                | `""`                              |
| `mcp.serviceAccount.create`                                  | Specifies whether a ServiceAccount should be created                                                                                                                                                                                | `true`                            |
| `mcp.serviceAccount.name`                                    | The name of the ServiceAccount to use.                                                                                                                                                                                              | `""`                              |
| `mcp.serviceAccount.annotations`                             | Additional Service Account annotations (evaluated as a template)                                                                                                                                                                    | `{}`                              |
| `mcp.serviceAccount.automountServiceAccountToken`            | Automount service account token for the MCP MongoDB service account                                                                                                                                                                 | `false`                           |
| `mcp.service.type`                                           | Kubernetes Service type                                                                                                                                                                                                             | `ClusterIP`                       |
| `mcp.service.clusterIP`                                      | MCP MongoDB service Cluster IP                                                                                                                                                                                                      | `""`                              |
| `mcp.service.ports.http`                                     | MCP MongoDB service HTTP port                                                                                                                                                                                                       | `8000`                            |
| `mcp.service.ports.https`                                    | MCP MongoDB service HTTPS port (used when auth is enabled)                                                                                                                                                                          | `8443`                            |
| `mcp.service.nodePorts.http`                                 | Specify the nodePort value for the LoadBalancer and NodePort service types                                                                                                                                                          | `""`                              |
| `mcp.service.nodePorts.https`                                | Specify the nodePort value for HTTPS when auth is enabled                                                                                                                                                                           | `""`                              |
| `mcp.service.loadBalancerIP`                                 | loadBalancerIP if MCP MongoDB service type is `LoadBalancer` (optional, cloud specific)                                                                                                                                             | `""`                              |
| `mcp.service.loadBalancerClass`                              | loadBalancerClass if MCP MongoDB service type is `LoadBalancer` (optional, cloud specific)                                                                                                                                          | `""`                              |
| `mcp.service.loadBalancerSourceRanges`                       | loadBalancerSourceRanges if MCP MongoDB service type is `LoadBalancer` (optional, cloud specific)                                                                                                                                   | `[]`                              |
| `mcp.service.annotations`                                    | Provide any additional annotations which may be required.                                                                                                                                                                           | `{}`                              |
| `mcp.service.externalTrafficPolicy`                          | MCP MongoDB service external traffic policy                                                                                                                                                                                         | `Cluster`                         |
| `mcp.service.extraPorts`                                     | Extra port to expose on MCP MongoDB service                                                                                                                                                                                         | `[]`                              |
| `mcp.service.sessionAffinity`                                | Session Affinity for Kubernetes service, can be "None" or "ClientIP"                                                                                                                                                                | `None`                            |
| `mcp.service.sessionAffinityConfig`                          | Additional settings for the sessionAffinity. Ignored if `mcp.service.sessionAffinity` is `None`                                                                                                                                     | `{}`                              |
| `mcp.networkPolicy.enabled`                                  | Specifies whether a NetworkPolicy should be created                                                                                                                                                                                 | `true`                            |
| `mcp.networkPolicy.allowExternal`                            | Don't require server label for connections                                                                                                                                                                                          | `true`                            |
| `mcp.networkPolicy.allowExternalEgress`                      | Allow the pod to access any range of port and all destinations.                                                                                                                                                                     | `true`                            |
| `mcp.networkPolicy.addExternalClientAccess`                  | Allow access from pods with client label set to "true". Ignored if `mcp.networkPolicy.allowExternal` is true.                                                                                                                       | `true`                            |
| `mcp.networkPolicy.extraIngress`                             | Add extra ingress rules to the NetworkPolicy                                                                                                                                                                                        | `[]`                              |
| `mcp.networkPolicy.extraEgress`                              | Add extra ingress rules to the NetworkPolicy                                                                                                                                                                                        | `[]`                              |
| `mcp.networkPolicy.kubeAPIServerPorts`                       | List of Kubernetes API Server ports. Required when mcp.auth.enabled is true for kube-rbac-proxy to communicate with the API server.                                                                                                 | `[]`                              |
| `mcp.networkPolicy.ingressPodMatchLabels`                    | Labels to match to allow traffic from other pods. Ignored if `mcp.networkPolicy.allowExternal` is true.                                                                                                                             | `{}`                              |
| `mcp.networkPolicy.ingressNSMatchLabels`                     | Labels to match to allow traffic from other namespaces. Ignored if `mcp.networkPolicy.allowExternal` is true.                                                                                                                       | `{}`                              |
| `mcp.networkPolicy.ingressNSPodMatchLabels`                  | Pod labels to match to allow traffic from other namespaces. Ignored if `mcp.networkPolicy.allowExternal` is true.                                                                                                                   | `{}`                              |
| `mcp.httpRoute.enabled`                                      | Enable HTTPRoute generation for MCP                                                                                                                                                                                                 | `false`                           |
| `mcp.httpRoute.annotations`                                  | Additional annotations for the HTTPRoute resource                                                                                                                                                                                   | `{}`                              |
| `mcp.httpRoute.labels`                                       | Additional labels for the HTTPRoute resource                                                                                                                                                                                        | `{}`                              |
| `mcp.httpRoute.parentRefs`                                   | Gateways the HTTPRoute is attached to. If unspecified, it'll be attached to Gateway named 'gateway' in the same namespace.                                                                                                          | `[]`                              |
| `mcp.httpRoute.hostnames`                                    | List of hostnames matching HTTP header                                                                                                                                                                                              | `[]`                              |
| `mcp.httpRoute.matches`                                      | List of match rules applied to the HTTPRoute for the default svc backend reference                                                                                                                                                  | `[]`                              |
| `mcp.httpRoute.filters`                                      | List of filter rules applied to the HTTPRoute for the default svc backend reference                                                                                                                                                 | `[]`                              |
| `mcp.httpRoute.extraRules`                                   | List of extra rules applied to the HTTPRoute                                                                                                                                                                                        | `[]`                              |
| `mcp.backendTLSPolicy.enabled`                               | Enable BackendTLSPolicy for MCP HTTPRoute (requires mcp.auth.enabled)                                                                                                                                                               | `false`                           |
| `mcp.backendTLSPolicy.hostname`                              | Hostname for backend TLS validation                                                                                                                                                                                                 | `""`                              |
| `mcp.backendTLSPolicy.subjectAltNames`                       | Additional Subject Alternative Names for backend TLS validation                                                                                                                                                                     | `[]`                              |
| `mcp.backendTLSPolicy.annotations`                           | Additional annotations for the BackendTLSPolicy resource                                                                                                                                                                            | `{}`                              |
| `mcp.backendTLSPolicy.labels`                                | Additional labels for the BackendTLSPolicy resource                                                                                                                                                                                 | `{}`                              |
| `mcp.ingress.enabled`                                        | Set to true to enable ingress record generation                                                                                                                                                                                     | `false`                           |
| `mcp.ingress.pathType`                                       | Ingress Path type                                                                                                                                                                                                                   | `ImplementationSpecific`          |
| `mcp.ingress.apiVersion`                                     | Override API Version (automatically detected if not set)                                                                                                                                                                            | `""`                              |
| `mcp.ingress.hostname`                                       | When the ingress is enabled, a host pointing to this will be created                                                                                                                                                                | `mcp-mongodb.local`               |
| `mcp.ingress.path`                                           | Default path for the ingress resource                                                                                                                                                                                               | `/`                               |
| `mcp.ingress.annotations`                                    | Additional annotations for the Ingress resource. To enable certificate autogeneration, place here your cert-manager annotations.                                                                                                    | `{}`                              |
| `mcp.ingress.tls`                                            | Enable TLS configuration for the hostname defined at mcp.ingress.hostname parameter                                                                                                                                                 | `false`                           |
| `mcp.ingress.extraHosts`                                     | The list of additional hostnames to be covered with this ingress record.                                                                                                                                                            | `[]`                              |
| `mcp.ingress.extraPaths`                                     | Any additional arbitrary paths that may need to be added to the ingress under the main host.                                                                                                                                        | `[]`                              |
| `mcp.ingress.extraTls`                                       | The tls configuration for additional hostnames to be covered with this ingress record.                                                                                                                                              | `[]`                              |
| `mcp.ingress.secrets`                                        | If you're providing your own certificates, please use this to add the certificates as secrets                                                                                                                                       | `[]`                              |
| `mcp.ingress.secrets`                                        | It is also possible to create and manage the certificates outside of this helm chart                                                                                                                                                | `[]`                              |
| `mcp.ingress.selfSigned`                                     | Create a TLS secret for this ingress record using self-signed certificates generated by Helm                                                                                                                                        | `false`                           |
| `mcp.ingress.ingressClassName`                               | IngressClass that will be be used to implement the Ingress (Kubernetes 1.18+)                                                                                                                                                       | `""`                              |
| `mcp.ingress.extraRules`                                     | Additional rules to be covered with this ingress record                                                                                                                                                                             | `[]`                              |
| `mcp.auth.enabled`                                           | Enable authentication/authorization using kube-rbac-proxy sidecar                                                                                                                                                                   | `true`                            |
| `mcp.auth.image.registry`                                    | kube-rbac-proxy image registry                                                                                                                                                                                                      | `REGISTRY_NAME`                   |
| `mcp.auth.image.repository`                                  | kube-rbac-proxy image repository                                                                                                                                                                                                    | `REPOSITORY_NAME/kube-rbac-proxy` |
| `mcp.auth.image.digest`                                      | kube-rbac-proxy image digest in the way sha256:aa.... Please note this parameter, if set, will override the tag                                                                                                                     | `""`                              |
| `mcp.auth.image.pullPolicy`                                  | kube-rbac-proxy image pull policy                                                                                                                                                                                                   | `IfNotPresent`                    |
| `mcp.auth.image.pullSecrets`                                 | kube-rbac-proxy image pull secrets                                                                                                                                                                                                  | `[]`                              |
| `mcp.auth.extraArgs`                                         | Add extra arguments to the default args                                                                                                                                                                                             | `[]`                              |
| `mcp.auth.containerPorts.https`                              | kube-rbac-proxy https container port                                                                                                                                                                                                | `8443`                            |
| `mcp.auth.containerPorts.health`                             | kube-rbac-proxy health container port                                                                                                                                                                                               | `8888`                            |
| `mcp.auth.tls.existingSecret`                                | Name of an existing secret containing the TLS certificates                                                                                                                                                                          | `""`                              |
| `mcp.auth.tls.cert`                                          | Certificate data (PEM format). Required if autoGenerated.enabled=false and existingSecret is empty                                                                                                                                  | `""`                              |
| `mcp.auth.tls.key`                                           | Certificate key data (PEM format). Required if autoGenerated.enabled=false and existingSecret is empty                                                                                                                              | `""`                              |
| `mcp.auth.tls.certFilename`                                  | Certificate filename                                                                                                                                                                                                                | `""`                              |
| `mcp.auth.tls.keyFilename`                                   | Certificate key filename                                                                                                                                                                                                            | `""`                              |
| `mcp.auth.tls.autoGenerated.enabled`                         | Enable auto-generation of TLS certificates                                                                                                                                                                                          | `true`                            |
| `mcp.auth.tls.autoGenerated.engine`                          | Engine to auto-generate TLS certificates (allowed values: helm, cert-manager)                                                                                                                                                       | `helm`                            |
| `mcp.auth.tls.autoGenerated.extraSANs`                       | Extra Subject Alternative Names to be added to the TLS certificate                                                                                                                                                                  | `[]`                              |
| `mcp.auth.tls.autoGenerated.loopback`                        | Add loopback IP (127.0.0.1) to certificate SAN                                                                                                                                                                                      | `true`                            |
| `mcp.auth.tls.autoGenerated.certManager.existingIssuer`      | Name of an existing Issuer to use for certificate generation                                                                                                                                                                        | `""`                              |
| `mcp.auth.tls.autoGenerated.certManager.existingIssuerKind`  | Kind of the existing Issuer (Issuer or ClusterIssuer)                                                                                                                                                                               | `Issuer`                          |
| `mcp.auth.tls.autoGenerated.certManager.keyAlgorithm`        | Private key algorithm for the certificate                                                                                                                                                                                           | `RSA`                             |
| `mcp.auth.tls.autoGenerated.certManager.keySize`             | Size of the private key                                                                                                                                                                                                             | `2048`                            |
| `mcp.auth.tls.autoGenerated.certManager.duration`            | Duration of the certificate                                                                                                                                                                                                         | `8760h`                           |
| `mcp.auth.tls.autoGenerated.certManager.renewBefore`         | Time before expiration to renew the certificate                                                                                                                                                                                     | `360h`                            |
| `mcp.auth.extraContainerPorts`                               | Optionally specify extra list of additional container ports for kube-rbac-proxy                                                                                                                                                     | `[]`                              |
| `mcp.auth.extraEnvVars`                                      | Array with extra environment variables to add to kube-rbac-proxy                                                                                                                                                                    | `[]`                              |
| `mcp.auth.extraVolumeMounts`                                 | Optionally specify extra list of additional volumeMounts for the kube-rbac-proxy container                                                                                                                                          | `[]`                              |
| `mcp.auth.allowedServiceAccounts`                            | List of service accounts allowed to access MCP MongoDB endpoint                                                                                                                                                                     | `[]`                              |
| `mcp.auth.resourcesPreset`                                   | Set container resources according to one common preset (allowed values: none, nano, micro, small, medium, large, xlarge, 2xlarge). This is ignored if mcp.auth.resources is set (mcp.auth.resources is recommended for production). | `nano`                            |
| `mcp.auth.resources`                                         | Set container requests and limits for different resources like CPU or memory (essential for production workloads)                                                                                                                   | `{}`                              |
| `mcp.auth.fips.openssl`                                      | Configure OpenSSL FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                  | `""`                              |
| `mcp.auth.fips.golang`                                       | Configure Golang FIPS mode: '', 'restricted', 'relaxed', 'off'. If empty (""), 'global.defaultFips' would be used                                                                                                                   | `relaxed`                         |
| `mcp.auth.livenessProbe.enabled`                             | Enable livenessProbe on kube-rbac-proxy containers                                                                                                                                                                                  | `true`                            |
| `mcp.auth.livenessProbe.initialDelaySeconds`                 | Initial delay seconds for livenessProbe                                                                                                                                                                                             | `5`                               |
| `mcp.auth.livenessProbe.periodSeconds`                       | Period seconds for livenessProbe                                                                                                                                                                                                    | `10`                              |
| `mcp.auth.livenessProbe.timeoutSeconds`                      | Timeout seconds for livenessProbe                                                                                                                                                                                                   | `5`                               |
| `mcp.auth.livenessProbe.failureThreshold`                    | Failure threshold for livenessProbe                                                                                                                                                                                                 | `5`                               |
| `mcp.auth.livenessProbe.successThreshold`                    | Success threshold for livenessProbe                                                                                                                                                                                                 | `1`                               |
| `mcp.auth.readinessProbe.enabled`                            | Enable readinessProbe on kube-rbac-proxy containers                                                                                                                                                                                 | `true`                            |
| `mcp.auth.readinessProbe.initialDelaySeconds`                | Initial delay seconds for readinessProbe                                                                                                                                                                                            | `5`                               |
| `mcp.auth.readinessProbe.periodSeconds`                      | Period seconds for readinessProbe                                                                                                                                                                                                   | `10`                              |
| `mcp.auth.readinessProbe.timeoutSeconds`                     | Timeout seconds for readinessProbe                                                                                                                                                                                                  | `5`                               |
| `mcp.auth.readinessProbe.failureThreshold`                   | Failure threshold for readinessProbe                                                                                                                                                                                                | `5`                               |
| `mcp.auth.readinessProbe.successThreshold`                   | Success threshold for readinessProbe                                                                                                                                                                                                | `1`                               |
| `mcp.auth.startupProbe.enabled`                              | Enable startupProbe on kube-rbac-proxy containers                                                                                                                                                                                   | `false`                           |
| `mcp.auth.startupProbe.initialDelaySeconds`                  | Initial delay seconds for startupProbe                                                                                                                                                                                              | `5`                               |
| `mcp.auth.startupProbe.periodSeconds`                        | Period seconds for startupProbe                                                                                                                                                                                                     | `10`                              |
| `mcp.auth.startupProbe.timeoutSeconds`                       | Timeout seconds for startupProbe                                                                                                                                                                                                    | `5`                               |
| `mcp.auth.startupProbe.failureThreshold`                     | Failure threshold for startupProbe                                                                                                                                                                                                  | `5`                               |
| `mcp.auth.startupProbe.successThreshold`                     | Success threshold for startupProbe                                                                                                                                                                                                  | `1`                               |
| `mcp.auth.customLivenessProbe`                               | Custom livenessProbe that overrides the default one                                                                                                                                                                                 | `{}`                              |
| `mcp.auth.customReadinessProbe`                              | Custom readinessProbe that overrides the default one                                                                                                                                                                                | `{}`                              |
| `mcp.auth.customStartupProbe`                                | Custom startupProbe that overrides the default one                                                                                                                                                                                  | `{}`                              |
| `mcp.auth.containerSecurityContext.enabled`                  | Enabled containers' Security Context                                                                                                                                                                                                | `true`                            |
| `mcp.auth.containerSecurityContext.seLinuxOptions`           | Set SELinux options in container                                                                                                                                                                                                    | `{}`                              |
| `mcp.auth.containerSecurityContext.runAsUser`                | Set containers' Security Context runAsUser                                                                                                                                                                                          | `1001`                            |
| `mcp.auth.containerSecurityContext.runAsGroup`               | Set containers' Security Context runAsGroup                                                                                                                                                                                         | `1001`                            |
| `mcp.auth.containerSecurityContext.runAsNonRoot`             | Set container's Security Context runAsNonRoot                                                                                                                                                                                       | `true`                            |
| `mcp.auth.containerSecurityContext.privileged`               | Set container's Security Context privileged                                                                                                                                                                                         | `false`                           |
| `mcp.auth.containerSecurityContext.readOnlyRootFilesystem`   | Set container's Security Context readOnlyRootFilesystem                                                                                                                                                                             | `true`                            |
| `mcp.auth.containerSecurityContext.allowPrivilegeEscalation` | Set container's Security Context allowPrivilegeEscalation                                                                                                                                                                           | `false`                           |
| `mcp.auth.containerSecurityContext.capabilities.drop`        | List of capabilities to be dropped                                                                                                                                                                                                  | `["ALL"]`                         |
| `mcp.auth.containerSecurityContext.seccompProfile.type`      | Set container's Security Context seccomp profile                                                                                                                                                                                    | `RuntimeDefault`                  |
